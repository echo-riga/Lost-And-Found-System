...
// SQL query to fetch the latest 4 audit log entries
$sql = "SELECT log_id, table_name, action, description, log_time FROM audit_log ORDER BY log_time DESC LIMIT 4";
